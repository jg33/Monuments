...
namespace VRStandardAssets.Utils
{
    ...
    {
        public GameObject[] m_Prefabs;            // These are prefabs which are all variations of the same (for example various asteroids).
        public int m_NumberInPool;                // The number of prefabs to be initially instanced for the pool.
