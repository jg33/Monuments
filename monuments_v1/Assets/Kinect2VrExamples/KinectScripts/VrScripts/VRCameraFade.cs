...
namespace VRStandardAssets.Utils
{
    ...
    public class VRCameraFade : MonoBehaviour
    {
        ...
        public AudioMixerSnapshot m_DefaultSnapshot;  // Settings for the audio mixer to use normally.
        public AudioMixerSnapshot m_FadedSnapshot;    // Settings for the audio mixer to use when faded out.
        public Color m_FadeColor = Color.black;       // The colour the image fades out to.
        ...
        public bool m_FadeInOnStart = false;          // Whether a fade in should happen just but Updates start.
