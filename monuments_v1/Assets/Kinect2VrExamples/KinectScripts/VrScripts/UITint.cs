...
namespace VRStandardAssets.Utils
{
    ...
    {
        public Color m_Tint;                                  // The colour to tint the Images.
        [Range (0f, 1f)] public float m_TintPercent = 0.5f;   // How much the colour should be used.
        public Image[] m_ImagesToTint;                        // References to the images which will be tinted.
        public VRInteractiveItem m_InteractiveItem;           // Reference to the VRInteractiveItem which must be looked at to tint the images.
		...
		private void HandleOver (Transform trans)
        {
		...
		private void HandleOut (Transform trans)
        {
