...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        public AudioSource m_Audio;                       // Reference to the audio source that will play effects when the user looks at it and when it fills.
        public AudioClip m_OnOverClip;                    // The clip to play when the user looks at the bar.
