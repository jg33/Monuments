...
namespace VRStandardAssets.Utils
{
    ...
    {
        public float m_DefaultDistance = 5f;      // The default distance away from the camera the reticle is placed.
		public bool m_UseNormal;                  // Whether the reticle should be placed parallel to a surface.
		public Image m_Image;                     // Reference to the image component that represents the reticle.
		public Transform m_ReticleTransform;      // We need to affect the reticle's transform.
		public Transform m_Camera;                // The reticle is always placed relative to the camera.
		...
		// This overload of SetPosition is used when using a raycast and the VREyeRaycaster hasn't hit anything.
		public void SetPosition (Vector3 rayPos, Vector3 rayDir)
		{
			// Set the position of the reticle to the default distance in front of the camera.
			m_ReticleTransform.position = rayPos + rayDir * m_DefaultDistance;
