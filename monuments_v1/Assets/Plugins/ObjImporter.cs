...
public class ObjImporter {
	...
	public static Mesh ImportFile (string filePath) {
		...
		Debug.Log("new verts length "+newVerts.Length.ToString());
		Debug.Log("new uv length "+newUVs.Length.ToString());
	...
	public static Mesh ImportFileWithHelp (string filePath, Mesh _oldMesh) {
		meshStruct newMesh = createMeshStruct(filePath);
		populateMeshStruct(ref newMesh);
